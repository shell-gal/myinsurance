...
public class Selfcarloss {
    private Integer selfCarlossId;
    ...
    public Integer getSelfCarlossId() {
        return selfCarlossId;
    }

    public void setSelfCarlossId(Integer selfCarlossId) {
        this.selfCarlossId = selfCarlossId;
    }
